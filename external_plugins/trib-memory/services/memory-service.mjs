...
const MEMORY_INSTRUCTIONS = [
  ...
  '- User says "이어서", "기억나?", "그거 뭐였지" → recall_memory(session="last") or recall_memory(query="...")',
  '- User asks about past events/decisions → recall_memory(query="topic")',
  '- User mentions a date → recall_memory(date="2026-04-02")',
  '- Auto-injected hints are not enough → recall_memory for more detail',
  '- NEVER guess from memory alone. If unsure, search first.',
  '',
