...
- If type="async_result": the merged answer of an earlier async dispatch (recall / search / explore) has arrived. Integrate it naturally into your next step — do NOT call `session_result` for this handle again.
