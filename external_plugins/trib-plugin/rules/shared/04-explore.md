...
- `mcp__plugin_trib-plugin_trib-plugin__explore` — internal codebase navigation. Each natural-language query is translated into glob + grep patterns (Haiku) and executed in parallel; one call can cover several angles.
