...
- `mcp__plugin_trib-plugin_trib-plugin__recall` — past facts, work, decisions. Natural-language query; an internal agent searches the memory store and returns a synthesized answer.
