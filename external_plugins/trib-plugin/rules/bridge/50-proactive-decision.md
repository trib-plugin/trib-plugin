...
chat grounded in the user's active core memory. Stateless, JSON-only.
...
5. **Compose**: conversational reply in the user's language, 2-4 sentences, include the real data found. No generic openers.
