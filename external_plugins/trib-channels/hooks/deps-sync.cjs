...
process.stdout.write(JSON.stringify({
  hookSpecificOutput: {
    ...
    additionalContext: 'trib-channels: dependencies installed. Restart Claude Code to connect MCP server.'
  }
}));
